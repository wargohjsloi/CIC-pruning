...
from dataset.imbalance_cifar_moco import ImbalanceCIFAR100_MOCO, ImbalanceCIFAR10_MOCO
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in tqdm(range(args.start_epoch, args.epochs), position=0, leave=True, disable=not args.is_master):
        ...
        save_checkpoint({
                ...
                }, is_best=False, filename=f'{args.root_model}/moco_ckpt.pth')
        ...
        if (epoch + 1) % args.print_freq == 0:
            save_checkpoint({
                ...
                'state_dict': model.state_dict(),
                'optimizer': optimizer.state_dict(),
            }, is_best=False, filename=f'{args.root_model}/moco_ckpt_{(epoch+1):04d}.pth')
