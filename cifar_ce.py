...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # model = getattr(resnet_cifar, args.arch)(num_classes=args.num_classes, use_norm=False)
    print(model)
...
def validate(val_loader, train_loader, model, criterion, tb_logger, epoch, args):
    ...
    with torch.no_grad():
        ...
        print('many acc:{} median acc:{} low acc:{}'.format(many_acc_top1, median_acc_top1, low_acc_top1))
